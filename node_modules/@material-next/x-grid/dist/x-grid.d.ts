...
export { LicenseInfo } from '@material-next/x-license';
import { ReactElement, RefObject, ElementType, MutableRefObject, Context, FC, MemoExoticComponent, ForwardRefExoticComponent, RefAttributes, ReactNode, HTMLAttributes, Component } from 'react';
 ...
 */
declare function createRow(rowData: RowData): RowModel;
 ...
 * The full grid API.
 */
declare type GridApi = CoreApi & EventsApi & RowApi & ColumnApi & SelectionApi & SortApi & VirtualizationApi & PaginationApi;
...
declare type PaginationState = PageChangeParams;
...
declare const AutoSizerWrapper: (...args: any[]) => any;
...
declare const ColumnHeaderItem: MemoExoticComponent<({ column, colIndex, onResizeColumn }: ColumnHeaderItemProps) => JSX.Element>;
 ...
 */
declare function useApiRef(): ApiRef;
...
declare const useSorting: (options: GridOptions, rowsProp: RowsProp, columnsProp: Columns, apiRef: ApiRef) => void;

declare function useApi(gridRootRef: RefObject<HTMLDivElement>, options: GridOptions, apiRef: ApiRef): boolean;
...
declare const useVirtualRows: (colRef: MutableRefObject<HTMLDivElement | null>, windowRef: MutableRefObject<HTMLDivElement | null>, renderingZoneRef: MutableRefObject<HTMLDivElement | null>, internalColumns: InternalColumns, rows: Rows, options: GridOptions, apiRef: ApiRef) => UseVirtualRowsReturnType;
...
declare const XGrid: MemoExoticComponent<ForwardRefExoticComponent<Pick<GridComponentProps, "autoHeight" | "rowHeight" | "headerHeight" | "scrollbarSize" | "columnBuffer" | "disableMultipleSelection" | "disableMultipleColumnsSorting" | "disableColumnResize" | "showCellRightBorder" | "showColumnRightBorder" | "disableExtendRowFullWidth" | "sortingOrder" | "pagination" | "pageSize" | "autoPageSize" | "rowsPerPageOptions" | "paginationMode" | "rowCount" | "page" | "sortingMode" | "hideFooter" | "hideFooterRowCount" | "hideFooterSelectedRowCount" | "hideFooterPagination" | "checkboxSelection" | "disableSelectionOnClick" | "logger" | "logLevel" | "sortModel" | "onCellClick" | "onCellHover" | "onRowClick" | "onRowHover" | "onRowSelected" | "onSelectionChange" | "onColumnHeaderClick" | "onSortModelChange" | "onPageChange" | "onPageSizeChange" | "onError" | "icons" | "columnTypes" | "rows" | "columns" | "components" | "apiRef" | "loading" | "className" | "error"> & RefAttributes<HTMLDivElement>>>;

export { Alignement, ApiContext, ApiRef, ArrowDownwardIcon, ArrowUpwardIcon, AutoSizerWrapper, CELL_CLICK, CELL_CSS_CLASS, CELL_HOVER, CLICK, COLUMNS_UPDATED, COLUMN_HEADER_CLICK, COLUMN_HEADER_HOVER, COL_RESIZE_START, COL_RESIZE_STOP, COMPONENT_ERROR, Cell, CellCheckboxRenderer, CellClassFn, CellClassNamePropType, CellClassParams, CellClassRules, CellIndexCoordinates, CellParams, CellValue, ColDef, ColParams, ColType, ColTypeDef, ColumnApi, ColumnHeaderItem, ColumnHeaderItemCollection, ColumnHeaderSeparator, ColumnHeaderSeparatorProps, ColumnHeaderSortIcon, ColumnHeaderSortIconProps, ColumnHeaderTitle, ColumnHeaderTitleProps, ColumnHeadersItemCollectionProps, ColumnLookup, ColumnTypesRecord, Columns, ColumnsHeader, ColumnsHeaderProps, ColumnsMeta, ComparatorFn, ComponentProps, ContainerProps, CoreApi, DATA_CONTAINER_CSS_CLASS, DATETIME_COL_DEF, DATE_COL_DEF, DEFAULT_COLUMN_TYPES, DEFAULT_COL_TYPE_KEY, DEFAULT_GRID_OPTIONS, DebouncedFunction, DefaultFooter, DefaultFooterProps, ElementSize, EventsApi, FOCUS_OUT, FeatureMode, FeatureModeConstant, FieldComparatorList, GRID_FOCUS_OUT, GridApi, GridCellProps, GridColumnsContainer, GridComponent, GridComponentOverridesProp, GridComponentProps, GridDataContainer, GridFooter, GridOptions, GridOptionsProp, GridOverlay, GridRoot, GridWindow, HEADER_CELL_CSS_CLASS, HeaderCheckbox, IconsOptions, InternalColumns, KEYDOWN, KEYUP, LeftEmptyCell, LoadingOverlay, Logger, MOUSE_HOVER, MULTIPLE_KEY_PRESS_CHANGED, MULTIPLE_SELECTION_KEYS, NUMERIC_COL_DEF, NativeColTypes, NoRowMessage, ObjectWithId, OptionsContext, PAGESIZE_CHANGED, PAGE_CHANGED, PageChangeParams, Pagination, PaginationApi, PaginationComponentProps, PaginationProps, PaginationState, RESIZE, ROWS_UPDATED, ROW_CLICK, ROW_CSS_CLASS, ROW_HOVER, ROW_SELECTED, RenderColumnsProps, RenderContext, RenderContextProps, RenderPaginationProps, RenderRowProps, RenderingZone, RightEmptyCell, RootContainerRef, Row, RowApi, RowCells, RowCount, RowData, RowId, RowModel, RowParams, RowProps, RowSelectedParams, Rows, RowsProp, SCROLL, SCROLLING, SCROLLING_START, SCROLLING_STOP, SELECTION_CHANGED, SORT_MODEL_CHANGE, STRING_COL_DEF, ScrollFn, ScrollParams, SelectedRowCount, SelectionApi, SelectionChangeParams, SeparatorIcon, SortApi, SortDirection, SortItem, SortModel, SortModelParams, StickyContainer, UNMOUNT, ValueFormatterParams, ValueGetterParams, Viewport, ViewportProps, VirtualizationApi, Watermark, WatermarkProps, XGrid, XGridProps, buildCellParams, buildRowParams, checkboxSelectionColDef, classnames, createRow, dateComparer, dateFormatter, dateTimeFormatter, debounce, findCellElementsFromCol, findDataContainerFromCurrent, findGridRootFromCurrent, findParentElementFromClassName, getCellElementFromIndexes, getColDef, getFieldFromHeaderElem, getIdFromRowElem, isArray, isArrowKeys, isCell, isDate, isDesc, isEqual, isFunction, isHeaderCell, isHomeOrEndKeys, isMultipleKey, isNavigationKey, isNumber, isObject, isOverflown, isPageKeys, isSpaceKey, isString, isTabKey, mergeColTypes, mergeOptions, nextSortDirection, nillComparer, numberComparer, removeUndefinedProps, stringNumberComparer, useApi, useApiEventHandler, useApiMethod, useApiRef, useColumnResize, useColumns, useComponents, useContainerProps, useKeyboard, useLogger, useLoggerFactory, useNativeEventListener, usePagination, useRafUpdate, useRows, useScrollFn, useSelection, useSorting, useVirtualColumns, useVirtualRows };
